  ...
  */
  ...
  void GenericContainer::to_yaml( ostream_type & stream, string_view prefix ) const
  {
    switch ( m_data_type )
    {
      ...
      case GC_type::BOOL: stream << ( m_data.b ? "true" : "false" ) << '\n'; break;
      case GC_type::INTEGER: stream << m_data.i << '\n'; break;
      case GC_type::LONG: stream << m_data.l << '\n'; break;
      case GC_type::REAL: stream << m_data.r << '\n'; break;
      case GC_type::COMPLEX: stream << to_string( *m_data.c ) << '\n'; break;
      case GC_type::STRING:
