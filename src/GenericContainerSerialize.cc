...
namespace GC_namespace {
  ...
  static
  int32_t
  int8_to_buffer( int8_t in, uint8_t * buffer, int32_t const available ) {
  ...
  static
  int32_t
  uint32_to_buffer( uint32_t in, uint8_t * buffer, int32_t const available ) {
  ...
  static
  int32_t
  int32_to_buffer( int32_t in, uint8_t * buffer, int32_t const available ) {
    return uint32_to_buffer( *reinterpret_cast<uint32_t*>(&in), buffer, available );
  }

  static
  int32_t
  uint64_to_buffer( uint64_t in, uint8_t * buffer, int32_t const available ) {
  ...
  static
  int32_t
  int64_to_buffer( int64_t in, uint8_t * buffer, int32_t const available ) {
    return uint64_to_buffer( *reinterpret_cast<uint64_t*>(&in), buffer, available );
  }

  static
  int32_t
  double_to_buffer( double const in, uint8_t * buffer, int32_t const available ) {
