...
namespace GC_namespace
{
  ...
  static void mx_to_vec_bool( mxArray const * mx, GenericContainer & gc )
  {
    if ( mxGetNumberOfElements( mx ) == 1 ) { gc = mxIsLogicalScalarTrue( mx ); }
    else
    {
      ...
      for ( unsigned idx{ 0 }; idx < total_num_of_elements; ++idx ) vec[idx] = *pr++;
    }
  }

  template <typename T> static void mx_to_vec_int( mxArray const * mx, GenericContainer & gc )
  {
    mwSize const * dims{ mxGetDimensions( mx ) };
    T *            pr{ static_cast<T *>( mxGetData( mx ) ) };
    if ( mxGetNumberOfElements( mx ) == 1 ) { gc.set_int( int_type( *pr ) ); }
    else
    {
      unsigned total_num_of_elements{ static_cast<unsigned>( mxGetNumberOfElements( mx ) ) };
      ...
      switch ( number_of_dimensions )
      {
        case 1:
        {
          ...
          for ( unsigned idx{ 0 }; idx < total_num_of_elements; ++idx ) vec[idx] = int_type( *pr++ );
        }
        break;
        case 2:
        {
          ...
          else
          {
            ...
            for ( unsigned j{ 0 }; j < ny; ++j )
              for ( unsigned i{ 0 }; i < nx; ++i ) mat( i, j ) = int_type( *pr++ );
          }
        }
        break;
        default: mexPrintf( "number_of_dimensions = %d\n", number_of_dimensions ); break;
      }
    }
  }

  template <typename T> static void mx_to_vec_long( mxArray const * mx, GenericContainer & gc )
  {
    mwSize const * dims{ mxGetDimensions( mx ) };
    T *            pr{ static_cast<T *>( mxGetData( mx ) ) };
    if ( mxGetNumberOfElements( mx ) == 1 ) { gc.set_long( long_type( *pr ) ); }
    else
    {
      unsigned number_of_dimensions{ static_cast<unsigned>( mxGetNumberOfDimensions( mx ) ) };
      unsigned total_num_of_elements{ static_cast<unsigned>( mxGetNumberOfElements( mx ) ) };
      switch ( number_of_dimensions )
      {
        case 1:
        {
          ...
          for ( unsigned idx{ 0 }; idx < total_num_of_elements; ++idx ) vec[idx] = long_type( *pr++ );
        }
        break;
        case 2:
        {
          ...
          else
          {
            ...
            for ( unsigned j{ 0 }; j < ny; ++j )
              for ( unsigned i{ 0 }; i < nx; ++i ) mat( i, j ) = long_type( *pr++ );
          }
        }
        break;
        default: mexPrintf( "number_of_dimensions = %d\n", number_of_dimensions ); break;
  ...
  template <typename T> static void mx_to_vec_real( mxArray const * mx, GenericContainer & gc )
  {
    mwSize const * dims = mxGetDimensions( mx );
    T *            pr   = static_cast<T *>( mxGetData( mx ) );
    if ( mxGetNumberOfElements( mx ) == 1 ) { gc = real_type( *pr ); }
    else
    {
      unsigned total_num_of_elements{ static_cast<unsigned>( mxGetNumberOfElements( mx ) ) };
      unsigned number_of_dimensions{ static_cast<unsigned>( mxGetNumberOfDimensions( mx ) ) };
      switch ( number_of_dimensions )
      {
        case 1:
        {
          ...
          for ( mwSize idx = 0; idx < total_num_of_elements; ++idx ) vec[idx] = real_type( *pr++ );
        }
        break;
        case 2:
        {
          ...
          {
            vec_real_type & vec{ gc.set_vec_real( total_num_of_elements ) };
            for ( unsigned idx{ 0 }; idx < total_num_of_elements; ++idx ) vec[idx] = real_type( *pr++ );
          }
          else
          {
            mat_real_type & mat = gc.set_mat_real( nx, ny );
            for ( unsigned idx{ 0 }; idx < total_num_of_elements; ++idx ) mat[idx] = real_type( *pr++ );
          }
        }
        break;
        default: mexPrintf( "number_of_dimensions = %d\n", number_of_dimensions ); break;
  ...
  template <typename T> static void mx_to_vec_complex( mxArray const * mx, GenericContainer & gc )
  {
    mwSize const * dims = mxGetDimensions( mx );
  ...
  template <typename T> static void mx_to_vec_complex( mxArray const * mx, GenericContainer & gc )
  {
    ...
    if ( mxGetNumberOfElements( mx ) == 1 ) { gc = complex_type( real_type( *pr ), real_type( *pi ) ); }
    else
    {
      unsigned number_of_dimensions{ static_cast<unsigned>( mxGetNumberOfDimensions( mx ) ) };
      unsigned total_num_of_elements{ static_cast<unsigned>( mxGetNumberOfElements( mx ) ) };
  ...
  static void mx_to_vector( mxArray const * mx, GenericContainer & gc )
  {
  ...
  static void mx_to_map( mxArray const * mx, GenericContainer & gc )
  {
    gc.set_map();
  ...
  void mxSparse_to_GenericContainer( mxArray const * mx, GenericContainer & gc )
  {
    ...
    if ( mxIsComplex( mx ) )
    {
      ...
      for ( unsigned i{ 0 }; i < nnz; ++i ) { val[i] = complex_type( data[i].real, data[i].imag ); }
#else
  ...
  void mxArray_to_GenericContainer( mxArray const * mx, GenericContainer & gc )
  {
    ...
    // mexPrintf("\n\n\n%s\n\n\n",mxGetClassName(mx));
    if ( category == mxCELL_CLASS ) { mx_to_vector( mx, gc ); }
    else if ( category == mxSTRUCT_CLASS ) { mx_to_map( mx, gc ); }
    else if ( category == mxCHAR_CLASS ) { gc = mxArrayToString( mx ); }
    else if ( mxIsSparse( mx ) ) { mxSparse_to_GenericContainer( mx, gc ); }
    ...
    else
    {
      if ( mxIsComplex( mx ) )
      {
        switch ( category )
        {
          ...
          default: mexPrintf( "Complex Class ID = %d not converted!\n", category ); break;
        }
      }
      else
      {
        switch ( category )
        {
          ...
          default: mexPrintf( "Class ID = %d not converted!\n", category ); break;
        }
      }
    }
  }
  ...
  void to_mxArray( bool const & val_in, mxArray *& mx )
  {
  ...
  void to_mxArray( vec_string_type const & val, mxArray *& mx )
  {
    ...
    for ( mwSize i = 0; i < dims[0]; ++i ) mxSetCell( mx, i, mxCreateString( val[i].data() ) );
  }

  void to_mxArray( mat_int_type const & val, mxArray *& mx )
  {
    mwSize const nr = static_cast<mwSize>( val.num_rows() );
    mwSize const nc = static_cast<mwSize>( val.num_cols() );
    mwSize      dims[2] = { nr, nc };
    mx                  = mxCreateNumericArray( 2, dims, mxINT32_CLASS, mxREAL );
    int32_t * ptr       = static_cast<int32_t *>( mxGetData( mx ) );
    mwSize    k         = 0;
    for ( mwSize j{ 0 }; j < nc; ++j )
      for ( mwSize i{ 0 }; i < nr; ++i ) ptr[k++] = val( i, j );
  }
  ...
  void GenericContainer_to_mxArray( GenericContainer const & gc, mxArray *& mx )
  {
    ...
    switch ( gc.get_type() )
    {
      ...
      case GC_type::VEC_POINTER: mx = mxCreateDoubleMatrix( 0, 0, mxREAL ); break;
      case GC_type::BOOL:
      {
      ...
      {
        mwSize const nelems = static_cast<mwSize>( gc.get_num_elements() );
        dims[1]             = nelems;
        mx                  = mxCreateNumericArray( 2, dims, mxLOGICAL_CLASS, mxREAL );
        mxLogical * ptr     = static_cast<mxLogical *>( mxGetData( mx ) );
        for ( mwSize i = 0; i < nelems; ++i ) ptr[i] = gc.get_bool_at( i, where );
      }
      break;
      case GC_type::VEC_INTEGER:
      {
        ...
        mx                  = mxCreateNumericArray( 2, dims, mxINT64_CLASS, mxREAL );
        int64_t * ptr       = static_cast<int64_t *>( mxGetData( mx ) );
        for ( mwSize i = 0; i < nelems; ++i ) ptr[i] = static_cast<int64_t>( gc.get_int_at( i, where ) );
      }
      break;
      case GC_type::VEC_LONG:
      {
        ...
        mx                  = mxCreateNumericArray( 2, dims, mxINT64_CLASS, mxREAL );
        int64_t * ptr       = static_cast<int64_t *>( mxGetData( mx ) );
        for ( mwSize i = 0; i < nelems; ++i ) ptr[i] = static_cast<int64_t>( gc.get_long_at( i, where ) );
      }
      break;
      case GC_type::VEC_REAL:
      {
        ...
        mx                  = mxCreateNumericArray( 2, dims, mxDOUBLE_CLASS, mxREAL );
        real_type * ptr     = mxGetPr( mx );
        for ( mwSize i = 0; i < nelems; ++i ) ptr[i] = gc.get_real_at( i, where );
      }
      break;
      case GC_type::VEC_COMPLEX:
      {
        ...
        real_type * ptr = mxGetPr( mx );
        real_type * pti = mxGetPi( mx );
        for ( mwSize i = 0; i < nelems; ++i ) { gc.get_complex_number_at( i, ptr[i], pti[i] ); }
#endif
      }
      break;
      ...
      {
        mwSize const nr = static_cast<mwSize>( gc.num_rows() );
        mwSize const nc = static_cast<mwSize>( gc.num_cols() );
        dims[0]         = nr;
        dims[1]         = nc;
        mx              = mxCreateNumericArray( 2, dims, mxINT32_CLASS, mxREAL );
        ...
        mwSize     k    = 0;
        for ( mwSize j{ 0 }; j < nc; ++j )
          for ( mwSize i{ 0 }; i < nr; ++i ) ptr[k++] = gc.get_int_at( i, j, where );
      }
      break;
      case GC_type::MAT_LONG:
      {
        ...
        mwSize      k   = 0;
        for ( mwSize j{ 0 }; j < nc; ++j )
          for ( mwSize i{ 0 }; i < nr; ++i ) ptr[k++] = gc.get_long_at( i, j, where );
      }
      break;
      case GC_type::MAT_REAL:
      {
        ...
        mwSize      k   = 0;
        for ( mwSize j{ 0 }; j < nc; ++j )
          for ( mwSize i{ 0 }; i < nr; ++i ) ptr[k++] = gc.get_real_at( i, j, where );
      }
      break;
